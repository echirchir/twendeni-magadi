...
public class CreateMemberPledgeAsync extends AsyncTask<String, Void, String> {


    private Context context;

    public CreateMemberPledgeAsync(Context contxt){
        ...
        try {
            ...
            if (coreResponse != null){
                ...
                if (coreResponse.isSuccess()){
                    ...
                    EventBus.getDefault().post( new MemberPledgeCreatedEvent( true, pledgeId));

                }else{
                    EventBus.getDefault().post( new MemberPledgeCreatedEvent( false, 0));
                }
            }else{
                EventBus.getDefault().post( new MemberPledgeCreatedEvent( false, 0));
            }
