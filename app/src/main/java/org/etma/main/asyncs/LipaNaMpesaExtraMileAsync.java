...
public class LipaNaMpesaExtraMileAsync extends AsyncTask<String, Void, String> {

      public Context context;

    public LipaNaMpesaExtraMileAsync(Context contxt) {
      ...
      private ResponseBody createMpesaPaymentApiCall(String json, UserOauth userOauth)
        ...
        return createMemberPledgeCall(json, userOauth);
      }
      ...
      protected void onPostExecute(String response) {
        ...
        if (response != null && !response.equals("")){
            ...
            EventBus.getDefault().post( new LipaNaMpesaExtraMileEvent(true, payload, status));
        }else{
            EventBus.getDefault().post( new LipaNaMpesaExtraMileEvent(false));
        }
