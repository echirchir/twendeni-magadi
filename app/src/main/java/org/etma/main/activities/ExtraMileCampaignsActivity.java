...
public class ExtraMileCampaignsActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    @BindView(R.id.no_extra_mile_campaigns)
    TextView noExtraMileCampaigns;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extra_mile_campaigns);
        ...
        fab.setOnClickListener(view -> {
            //initialize donation form activity here;
            startActivity( new Intent(ExtraMileCampaignsActivity.this, DonateExtraMileActivity.class));
        });
    ...
    private void loadPayments(){
        ...
        if (adapter.getItemCount() != 0){
            noExtraMileCampaigns.setVisibility(View.GONE);
