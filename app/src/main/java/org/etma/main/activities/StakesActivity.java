...
public class StakesActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stakes);
    ...
    private void init(){
        ...
        RealmResults<PledgeStake> allStakes = realm.where(PledgeStake.class).findAll().sort("id", Sort.ASCENDING);

        if (!allStakes.isEmpty()){

            for ( PledgeStake stake : allStakes){

                stakes.add( new StakeObject(stake.getId(), stake.getStake()));
            }
        }
